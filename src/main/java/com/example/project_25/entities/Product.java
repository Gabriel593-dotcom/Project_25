...
public class Product implements Serializable {
	...
	// A instancia é realizada na declaração do atributo para garantirmos
	...
	// a associação e a chave estrangeira da outra entidade.
	...
	@Override
	public int hashCode() {
		return Objects.hash(categories, description, imgUrl, name, price);
	}
